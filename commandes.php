<?php
// commandes.php - Page d'historique des commandes
...
<script>
// Script pour exporter l'historique des commandes en PDF
document.getElementById('export-commandes-pdf').addEventListener('click', function() {
    ...
    pdf.text("<?php echo number_format($commande['total'], 2, ',', ' '); ?> €", 150, y);
    y += 10;

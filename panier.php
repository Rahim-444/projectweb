            ...
            <table class="panier-table">
                ...
                <tbody>
                    <?php foreach ($panier['articles'] as $article): ?>
                        <tr>
                            ...
                            <td class="prix"><?php echo number_format($article['prix'], 2, ',', ' '); ?> DZD</td>
                            <td class="quantite">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="total-amount" id="total-amount"><?php echo number_format($panier['total'], 2, ',', ' '); ?> DZD</td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
    ...
    document.getElementById('export-pdf').addEventListener('click', function() {
        ...
        <?php if (isset($panier['articles'])): ?>
            <?php foreach ($panier['articles'] as $article): ?>
                ...
                pdf.text("<?php echo number_format($article['prix'], 2, ',', ' '); ?> DZD", 100, y);
            ...
            pdf.text("<?php echo number_format($panier['total'], 2, ',', ' '); ?> DZD", 170, y);
        <?php endif; ?>

        // Pied de page
        pdf.setFontSize(10);
        pdf.text("Bibliothèque Vintage - Bouzareah Algerrr", 105, 280, null, null, "center");
